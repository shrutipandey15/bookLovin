...
const PostCard = ({ post }) => {
  ...
  return (
    <Link to={`/posts/${post.uid}`} className="flex">
      <div className="flex flex-col w-full rounded-2xl border border-secondary bg-background p-6 font-body text-text-primary shadow-sm transition-all hover:border-primary hover:shadow-lg">
        ...
        <p className="mb-4 flex-grow text-base leading-relaxed text-text-primary line-clamp-3">
          {content}
        </p>
